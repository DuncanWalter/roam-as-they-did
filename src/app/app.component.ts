...
export class AppComponent implements OnInit{
  ...
  ngOnInit(){
    ...
    bg.css('background','-webkit-linear-gradient(#F6956F, #FAB68D)'); /* For Safari 5.1 to 6.0 */
    bg.css('background','-o-linear-gradient(#F6956F, #FAB68D)'); /* For Opera 11.1 to 12.0 */
    bg.css('background','-moz-linear-gradient(#F6956F, #FAB68D)'); /* For Firefox 3.6 to 15 */
    bg.css('background','linear-gradient(#F6956F, #FAB68D)'); /* Standard syntax */
    $('.background-overlay').css('background-color', '#FAB68D').css('opacity','0');
  }
